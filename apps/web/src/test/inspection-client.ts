...
export function inspectionTestClient(
  ...
  return {
    ...
    getChangeRequest: unused,
    approveChangeRequest: unused,
    rejectChangeRequest: unused,
    withdrawChangeRequest: unused,
    ...
    requestWorkspaceInstallation: unused,
    requestWorkspaceUpdate: unused,
    requestWorkspacePolicyChange: unused,
